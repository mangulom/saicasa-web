...
@Component({
  selector: 'app-emorptaptimed',
  templateUrl: './emorptaptimed.component.html',
  styleUrls: ['./emorptaptimed.component.css']
})
export class EmorptaptimedComponent implements OnInit {
  ...
  descargarPdf(emo: Emo){
    ...
    this.emoService.getPdf(emo.id).subscribe(
      (result) => {
